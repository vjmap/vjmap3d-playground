    ...
    try {
        // 在线效果查看地址: https://vjmap.com/map3d/demo/#/demo/map/particle/07particlerain
        // --下雨粒子效果--
        ...
        let texture = await vjmap3d.ResManager.loadTextureSync(env.assetsPath +  "textures/rain.png");
        app.addParticle({
            system: {
                duration: 3,
                looping: true,
