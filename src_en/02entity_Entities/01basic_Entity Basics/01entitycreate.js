    ...
    try {
        ...
        // --Create entity--Create an entity and show entity config
...
let entity = vjmap3d.Entity.fromObject3d(box); // Create an entity from Object3D
entity.position.set(-3, 0.5, 0); // Set entity position
entity.addTo(app); // Add entity to app scene
// Entity config
