    ...
    try {
        // 在线效果查看地址: https://vjmap.com/map3d/demo/#/demo/map/builtin/objects/05builtinobjscreenquad
        // -- Full-screen quad (ScreenQuad) --
...
let shader = await new THREE.FileLoader().loadAsync(env.assetsPath + "shader/fire.frag")
let mat = new vjmap3d.ShadertoyMaterial(app, {
    shader: shader,
    brightOpacity: 1,
    mouseInputPos: [400, 200],
    transparent: true,
