    ...
    try {
        ...
        // --camera--
// Adapted from three.js official example https://threejs.org/examples/#webgl_camera
...
function init() {
    ...
    app.logInfo("Press O for orthographic camera, P for perspective camera", 60000)
