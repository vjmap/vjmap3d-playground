    ...
    try {
        ...
        // --decals--
        // Adapted from three.js official example https://threejs.org/examples/#webgl_decals
        ...
        function init() {
            ...
            app.signal.onMouseMove.add(e => {
                if (!(e.intersection  && e.entity == modelEntity)) return; // If no intersection or not on current entity
        ...
        async function loadLeePerrySmith() {
            ...
            // Color space must be LinearSRGBColorSpace
