    ...
    try {
        ...
        // --interactive_lines--
        // Adapted from three.js official example https://threejs.org/examples/#webgl_interactive_lines
        ...
        function init() {
            ...
            vjmap3d.Entity.attchObject(parentTransform); // Must be entity for queryEntitiesByScreenPos
