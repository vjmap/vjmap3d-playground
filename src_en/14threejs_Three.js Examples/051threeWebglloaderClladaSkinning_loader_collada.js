    ...
    try {
        ...
        // Adapted from three.js official example https://threejs.org/examples/#webgl_loader_collada_skinning
        ...
        async function init() {
            ...
            entity.addTo(app);
            entity.getModule(vjmap3d.AnimatorModule)?.getAnimator()?.play(); // Play animation
