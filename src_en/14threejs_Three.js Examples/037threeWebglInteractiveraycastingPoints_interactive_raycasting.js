    ...
    try {
        ...
        // Adapted from three.js official example https://threejs.org/examples/#webgl_interactive_raycasting_points
        ...
        function init() {
            ...
            pointclouds.forEach(p => vjmap3d.Entity.attchObject(p)); // Must be entity for queryEntitiesByScreenPos
