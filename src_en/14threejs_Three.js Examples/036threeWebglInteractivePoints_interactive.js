    ...
    try {
        ...
        // --interactive_points--
        // Adapted from three.js official example https://threejs.org/examples/#webgl_interactive_points
        ...
        function init() {
            ...
            scene.add( particles );
            let entity = vjmap3d.Entity.attchObject(particles); // Must be entity for queryEntitiesByScreenPos
