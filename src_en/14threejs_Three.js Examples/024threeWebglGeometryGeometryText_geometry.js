    ...
    try {
        ...
        // --geometry_text--
// Adapted from three.js official example https://threejs.org/examples/#webgl_geometry_text
...
let cameraTarget;
// When THREE.Cache.enabled is true, Three.js caches loaded textures, models, etc., improving performance.
// When false, cache is disabled and resources are reloaded each time. Default is false.
