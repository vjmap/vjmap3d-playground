...
let app = new vjmap3d.App(svc, {
    ...
    scene: {
        showAxesHelper: true, // Draw axes helper
...
let sse = drawRuler();
// Regenerate scale when size changes
...
const paddingInCssPixel = ( top, right, bottom, left ) => {
	...
	// Find nearest point iteratively
	for ( var i = 0; i < 10; i ++ ) {
...
const ui = await app.getConfigPane({ title: "Camera", style: { width: "300px"}});
